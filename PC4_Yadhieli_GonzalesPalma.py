...
#st.title("Quemándome las pestañas con Python. ¿Cómo amé algo que empecé odiando?"): # type: ignore #Esta línea está creando un título en la aplicación web.
...
st.markdown("<h1 style='text-align: center;'>Quemándome las pestañas con Python</h1>", unsafe_allow_html=True)

# Agregamos un subtítulo.
st.markdown("<h2 style='text-align: center;'>¿Cómo amé algo que empecé odiando?</h2>", unsafe_allow_html=True)
...
col1.image('Foto.png', caption='Yadhielí Gonzales Palma', width=300)
...
#Agregamos resaltadores para resumir el texto, primero lo agregamos a la col1 para que se vea más estético
col1.markdown("""
- Me gusta la naturaleza y los animales 🐾
- En mi tiempo libre: 🎮 videojuegos, 🎥 películas, y ✏️ escribir journals.
- Soy demasiado curiosa por cualquier tema 🌟
""")
...
"""
# Mostramos el texto
col2.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto_parte1}</div>", unsafe_allow_html=True)
...
"""
# Mostramos el texto
col2.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto_parte2}</div>", unsafe_allow_html=True)
...
#Agregamos más fotos
col1.image("Niko.png", caption='Niko', width=150)
col2.image("Zenitsu.png", caption='Zenitsu', width=150)
col3.image("Micho.png", caption='Micho', width=150)
col4.image("Mushu.png", caption='Mushu', width=150)
col5.image("Martin.png", caption='Martin', width=150)

#PARTE 2: APRENDIENDO A PROGRAMAR
# Agregamos un subtítulo.
...
# Mostramos el texto
col1.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto_1_programar}</div>", unsafe_allow_html=True)

#Ahora en la segunda columna
#Agrego mi foto personalizada
col2.image("Yo_programando.jpg", caption='Yo programando', width=350)

#Agregamos la segunda parte de mi experiencia
texto_2_programar =  """
...
Finalmente, estoy agradecida. Gracias al curso, y los aportes del docente y la JP Luisa, he logrado comprender y avanzar en la programación. Han despertado el interés en mí, incluso quiero seguir llevando cursos externos para poder mejorar, explanearme y crear más proyectos. Quiero seguir aprendiendo a programar. 
"""

# Mostramos el texto
col2.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto_2_programar}</div>", unsafe_allow_html=True)

#Agregamos la actualización de mi experiencia
texto_3_programar =  """
Esto es una actualización de mi experiencia: Hoy, miércoles 27, puedo decir que me gusta Visual Studio Code. Al inicio es algo tedioso, pero vale la pena. Realmente estoy amando el curso.
"""

# Mostramos el texto
col2.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto_3_programar}</div>", unsafe_allow_html=True)
...
# Agregamos un subtítulo
st.markdown("<h2 style='text-align: center;'>Explicación de dos temas vistos en clase 📚</h2>", unsafe_allow_html=True)
